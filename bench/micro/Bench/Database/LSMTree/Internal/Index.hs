...
import           Database.LSMTree.Extras.Generators (mkPages)
                     -- also for @Arbitrary@ instantiation of @SerialisedKey@
import           Database.LSMTree.Extras.Index (Append, append)
import           Database.LSMTree.Internal.Index (IndexType (Compact, Ordinary),
                     Index, newWithDefaults, search, unsafeEnd)
