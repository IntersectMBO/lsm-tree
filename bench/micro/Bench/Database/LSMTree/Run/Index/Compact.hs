...
module Bench.Database.LSMTree.Run.Index.Compact (
    benchmarks
...
import           Database.LSMTree.Run.Index.Compact
import           Database.LSMTree.Run.Index.Compact.Construction
import           Database.LSMTree.Serialise (SerialisedKey, serialiseKey)
...
benchmarks = bgroup "Bench.Database.LSMTree.Run.Index.Compact" [
      bgroup "searches" [
