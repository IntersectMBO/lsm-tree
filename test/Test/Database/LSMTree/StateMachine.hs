...
handleAbortActionRegistryError = \case
  AbortActionRegistryError abortReason actionErrors ->
    Model.ErrAbortActionRegistry $
      handleSomeException <$> maybe id NE.cons (getReasonExitCaseException abortReason) (getActionError <$> actionErrors)
...
handleFsError = Model.ErrDiskFault . displayException
