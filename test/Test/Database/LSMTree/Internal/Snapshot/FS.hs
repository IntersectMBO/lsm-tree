...
tests = testGroup "Test.Database.LSMTree.Internal.Snapshot.FS" [
    ...
    , testProperty "prop_fsRoundtrip - SnapshotMergingTree" $
        prop_fsRoundtrip readFileSnapshotMergingTree writeFileSnapshotMergingTree
    ...
    , testProperty "prop_fault_fsRoundtrip - SnapshotMergingTree" $
        prop_fault_fsRoundtrip readFileSnapshotMergingTree writeFileSnapshotMergingTree
