...
module Test.Database.LSMTree.Run.Construction (tests) where
...
import           Database.LSMTree.Run.Construction as Real
...
tests :: TestTree
tests = testGroup "Database.LSMTree.Run.Construction" [
      testGroup "RunAcc" [
