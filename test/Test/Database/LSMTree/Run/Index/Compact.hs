...
module Test.Database.LSMTree.Run.Index.Compact (tests) where
...
import           Data.Word
import           Database.LSMTree.BitMath
...
import           Database.LSMTree.Run.Index.Compact.Construction as Cons
import           Database.LSMTree.Serialise
import           Database.LSMTree.Util
import           Numeric (showHex)
import           Prelude hiding (max, min, pi)
import           Test.Database.LSMTree.Serialise ()
...
tests :: TestTree
tests = testGroup "Test.Database.LSMTree.Run.Index.Compact" [
