...
--
module Database.LSMTree.Run.Index.Compact (
    -- $compact
    CompactIndex (..)
  , PageNo (..)
  , NumPages
...
import           Database.LSMTree.ByteString (byteArrayFromTo)
...
{- $compact
  ...
  module "Database.LSMTree.Run.Index.Compact.Construction".
...
{- $incremental-serialisation
  ...
  Also see module "Database.LSMTree.Run.Index.Compact.Construction".
-}
