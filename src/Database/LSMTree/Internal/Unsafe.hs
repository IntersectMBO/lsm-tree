...
--
-- For more information, see 'Database.LSMTree.Types.Session'.
...
{-# SPECIALISE withSession ::
  ...
  -> (Session IO h -> IO a)
  -> IO a #-}
-- | See 'Database.LSMTree.Types.withSession'.
withSession ::
...
{-# SPECIALISE openSession ::
  ...
  -> FsPath
  -> IO (Session IO h) #-}
-- | See 'Database.LSMTree.Types.openSession'.
openSession ::
     forall m h.
...
-- | See 'Database.LSMTree.Types.closeSession'.
--
...
{-# SPECIALISE doesSnapshotExist ::
  ...
  -> SnapshotName
  -> IO Bool #-}
-- |  See 'Database.LSMTree.Types.doesSnapshotExist'.
doesSnapshotExist ::
...
{-# SPECIALISE deleteSnapshot ::
  ...
  -> SnapshotName
  -> IO () #-}
-- |  See 'Database.LSMTree.Types.deleteSnapshot'.
deleteSnapshot ::
     (MonadMask m, MonadSTM m)
  => Session m h
  -> SnapshotName
...
-- |  See 'Database.LSMTree.Types.listSnapshots'.
listSnapshots ::
     (MonadMask m, MonadSTM m)
  => Session m h
  -> m [SnapshotName]
