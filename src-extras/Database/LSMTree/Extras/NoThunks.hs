...
deriving stock instance Generic (LSMT.LookupResult v b)
deriving anyclass instance (NoThunks v, NoThunks b)
      => NoThunks (LSMT.LookupResult v b)

deriving stock instance Generic (LSMT.Entry k v b)
deriving anyclass instance (NoThunks k, NoThunks v, NoThunks b)
      => NoThunks (LSMT.Entry k v b)

deriving stock instance Generic (LSMT.Update v b)
deriving anyclass instance (NoThunks v, NoThunks b)
      => NoThunks (LSMT.Update v b)
...
instance (NoThunksIOLike m, Typeable m, Typeable (PrimState m))
  ...
  showTypeOf (_ :: Proxy (Types.Session m)) = "Types.Session"
...
instance (NoThunksIOLike m, Typeable m, Typeable (PrimState m))
  ...
  showTypeOf (_ :: Proxy (Types.Table m k v b)) = "Types.Table"
